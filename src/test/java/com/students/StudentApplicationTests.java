...
class StudentApplicationTests {
	...
	public void getStudentsTest() {
		when(repository.findAll()).thenReturn(Stream.of(new Student("Kausthub", "Adidam", "avs@gmail.com")).collect(Collectors.toList()));
		assertEquals(1, service.getAllStudent().size());
	}
	@Test
	public void deleteStudentTest() {
		Student student = new Student("Kausthub","Adidam", "avs@gmail.com");
		service.delete(0);
		verify(repository, times(0)).delete(student);
	}
	
	@Test
	public void getStudentByLastNameTest() {
		when(repository.findAll()).thenReturn(Stream.of(new Student("Kausthub", "Adidam", "k@gmail.com")).collect(Collectors.toList()));
		assertEquals(1, service.getAllStudent().size());
	}
	...
	public void updateStudentTest() {
		...
		student.setEmailId("k.a@gmail.com");
